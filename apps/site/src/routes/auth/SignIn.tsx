...
import type { SignInInput } from "@sst-app/service-one/validators";
import { signInInputSchema } from "@sst-app/service-one/validators";
...
export function SignIn() {
  ...
  const signInMutation = trpc.useMutation(["serviceOne.signIn"], {
    onSuccess: () => {
      navigate("/");
    }
  });
